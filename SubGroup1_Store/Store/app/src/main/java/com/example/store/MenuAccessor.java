...
public class MenuAccessor {
    ...
    public MenuAccessor(int num) {
        ...
        menu_list.add(new PMenu("시카고 피자", 19000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("콤비네이션 피자", 18000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("어깨쭉 피자", 50000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("포테이토 피자", 16000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("베이컨 피자", 17000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("페퍼로니 피자", 15000, R.drawable.hawaiian_pizza));
        menu_list.add(new PMenu("블랙 알리오 피자", 23000, R.drawable.hawaiian_pizza));
        ...
        menu_list.add(new PMenu("병역기 피자", 0, R.drawable.hawaiian_pizza));
